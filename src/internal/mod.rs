...
mod tests {
    ...
    impl HttpRequest for MockRequest {
        ...
        ///     headers: HeaderMap
        ///
        async fn get(&self, _url: Url, _headers: HeaderMap) -> CryptoMktResult<String> {
    ...
    #[tokio::test]
    async fn build_api_signature_format() {
        let api = setup_test();
    ...
    #[tokio::test]
    async fn build_api_signature_format_with_params_as_get_method() {
        let api = setup_test();
    ...
    #[tokio::test]
    async fn build_api_signature_with_params_as_post_method() {
        let api = setup_test();
        let mut params = HashMap::new();
        params.insert("amount".to_string(), "0.3".to_string());
        params.insert("market".to_string(), "ethclp".to_string());
    ...
    #[tokio::test]
    async fn sign_msg_with_payload() {
        let api = setup_test();
    ...
    #[tokio::test]
    async fn test_response_for_market_list() {
    ...
    #[tokio::test]
    async fn test_response_for_ticker() {
        let mock_transport = MockRequest::new(
    ...
    #[tokio::test]
    async fn test_response_for_book() {
        let mock_transport = MockRequest::new(
        ...
        let resp = api
            .get_edge::<BookResponse>("book", params, true)
            .await
            .unwrap();
    ...
    #[tokio::test]
    async fn test_response_for_trades() {
        let mock_transport = MockRequest::new(
    ...
    #[tokio::test]
    async fn test_response_for_orders_active() {
        let mock_transport = MockRequest::new(
    ...
    #[tokio::test]
    async fn test_response_for_orders_executed() {
        let mock_transport = MockRequest::new(
    ...
    #[tokio::test]
    async fn test_response_for_orders_create() {
        let mock_transport = MockRequest::new(
            "",
    ...
    #[tokio::test]
    async fn test_response_for_orders_status() {
        let mock_transport = MockRequest::new(
    ...
    #[tokio::test]
    async fn test_response_for_orders_cancel() {
        let mock_transport = MockRequest::new(
            "",
    ...
    #[tokio::test]
    async fn test_response_for_orders_instant_get() {
        let mock_transport = MockRequest::new(
    ...
    #[tokio::test]
    async fn test_response_for_orders_instant_create() {
    ...
    #[tokio::test]
    async fn test_response_for_balance() {
        let mock_transport = MockRequest::new(
